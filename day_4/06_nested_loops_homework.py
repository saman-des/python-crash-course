...
# Use two for loops with range(1, 11).
...
#
# Pattern A (right triangle):       Pattern B (inverted triangle):
# *                                 * * * * *
# * *                               * * * *
# * * *                             * * *
# * * * *                           * *
...
#   Ask the user "What is [a] × [b]?" for b from 1 to 5 (inner loop).
#   Check their answer and keep a score.
